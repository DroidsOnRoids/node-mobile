...
import com.mobileminer.R;
import com.mobileminer.MainActivity;
...
public class ForegroundService extends Service {
    public static final String APP_NAME = "Path Node";
    public static final String REACT_CLASS = "ForegroundService";
    private NotificationManager mNotificationManager;

    public static final String FOREGROUND = "com.mobileminer.ForegroundService";
  ...
  private Notification getCompatNotification() {
    ...
    String str = "Completing Path Jobs in the background";
    builder
